...
const payload = {
  ...
  modules: {
    map: { version:8,kingdom:"SK",step:2,round:4,mainKnightId:"k0",trackers:{time:7,threat:5,curse:2,unassignedClues:3},knights:[{id:"k0",name:"Renholder",heroId:"renholder",memberType:"knight",primary:"martial",secondary:"errant",clues:{martial:4,errant:3},virtues:{bravery:3,tenacity:1,sagacity:2,fortitude:0,might:4,insight:1}},{id:"k1",name:"Stoneface",heroId:"stoneface",memberType:"knight",primary:"martial",secondary:"historic",clues:{martial:2,historic:1},virtues:{bravery:2,tenacity:3,sagacity:0,fortitude:2,might:1,insight:2}},{id:"k2",name:"Kara",heroId:"kara",memberType:"knight",primary:"errant",secondary:"mystic",clues:{errant:3,mystic:2},virtues:{bravery:1,tenacity:2,sagacity:4,fortitude:1,might:0,insight:3}},{id:"k3",name:"法比奥（侍从）",heroId:"fabio",memberType:"squire",primary:"errant",secondary:"martial",clues:{errant:2,martial:1}}],maps:{SK:{placed:mapTiles.map(tile=>tile.id),tileState:Object.fromEntries(mapTiles.map((tile,index)=>[tile.id,index<8?"explored":"hidden"])),current:mapTiles[3]?.id,selected:mapTiles[3]?.id,showAll:false,partyPositions:{[mapTiles[3]?.id]:{x:52,y:48}},tileMarkers:[],pathMarkers:[],monsters:[],exploration:{activeEffect:activeExploration?.id||null,districtEffects,effectMarkers:{active:[{type:"generic",x:72,y:24}]}},fog:{active:false,target:mapTiles[4]?.id,total:4,intensity:3,started:true,current:null,used:fogCards.map((card,index)=>({cardId:card.id,value:card.fogValue,x:index<2?index:1,y:index<2?0:1})),route:fogCards.map((card,index)=>({cardId:card.id,value:card.fogValue,x:index<2?index:1,y:index<2?0:1}))}},POS:{}}},
